    ...
    try {
        ...
        if (
            ...
            const sampleServiceTasks = [
                // Maid Service tasks (8 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.maid,
                ...
                },
                {
                    ...
                    categoryId: serviceCategoryIds.maid,
                    taskCode: "ORGANIZE",
                    taskName: "Organization & Decluttering",
                    description: "Organize closets, storage areas, and living spaces",
                    isRequired: false,
                    defaultDuration: 90,
                    sortOrder: 6,
                },
                {
                    ...
                    categoryId: serviceCategoryIds.maid,
                    taskCode: "DEEP_CLEAN",
                    taskName: "Full House Deep Clean",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.maid,
                    taskCode: "CARPET_CLEAN",
                    taskName: "Carpet & Upholstery Cleaning",
                    description: "Professional carpet and furniture upholstery cleaning",
                    isRequired: false,
                    defaultDuration: 120,
                    sortOrder: 8,
                },

                // Transport tasks (5 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.transport,
                    taskCode: "AIRPORT_PICKUP",
                    taskName: "Airport Pickup",
                    description: "Pick up from airport to destination",
                    isRequired: false,
                    defaultDuration: 60,
                    sortOrder: 1,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.transport,
                    taskCode: "AIRPORT_DROPOFF",
                    taskName: "Airport Drop-off",
                    description: "Transport from location to airport",
                    isRequired: false,
                    defaultDuration: 60,
                    sortOrder: 2,
                },
                {
                    ...
                    categoryId: serviceCategoryIds.transport,
                    taskCode: "CITY_TOUR",
                    taskName: "City Tour Transport",
                    description: "Full-day city tour with driver",
                    isRequired: false,
                    defaultDuration: 480,
                    sortOrder: 3,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.transport,
                    taskCode: "HOURLY_RENTAL",
                    taskName: "Hourly Car Rental",
                    description: "Rent vehicle with driver by the hour",
                    isRequired: false,
                    defaultDuration: 60,
                    sortOrder: 4,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.transport,
                    taskCode: "LONG_DISTANCE",
                    taskName: "Long Distance Transport",
                    description: "Intercity or long-distance travel with driver",
                    isRequired: false,
                    defaultDuration: 360,
                    sortOrder: 5,
                },

                // Private Dining/Chef tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.dining,
                    taskCode: "BREAKFAST_PREP",
                    taskName: "Breakfast Preparation",
                    description: "Full breakfast service with fresh ingredients",
                    isRequired: false,
                    defaultDuration: 90,
                    sortOrder: 1,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.dining,
                    taskCode: "DINNER_PREP",
                    taskName: "Gourmet Dinner",
                    description: "Multi-course dinner with wine pairing",
                    isRequired: false,
                    defaultDuration: 180,
                    sortOrder: 2,
                },
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.dining,
                    taskCode: "PARTY_CATERING",
                    taskName: "Party Catering",
                    description: "Full catering service for events and parties",
                    isRequired: false,
                    defaultDuration: 300,
                    sortOrder: 4,
                },

                // Concierge tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.concierge,
                    taskCode: "RESERVATION",
                    taskName: "Restaurant Reservation",
                    description: "Book premium restaurant reservations",
                    isRequired: false,
                    defaultDuration: 15,
                    sortOrder: 1,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.concierge,
                    taskCode: "TICKET_BOOKING",
                    taskName: "Event Ticket Booking",
                    description: "Purchase tickets for shows, concerts, and events",
                    isRequired: false,
                    defaultDuration: 30,
                    sortOrder: 2,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.concierge,
                    taskCode: "SHOPPING_ASSIST",
                    taskName: "Personal Shopping",
                    description: "Personal shopping assistance and delivery",
                    isRequired: false,
                    defaultDuration: 120,
                    sortOrder: 3,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.concierge,
                    taskCode: "ITINERARY_PLAN",
                    taskName: "Itinerary Planning",
                    description: "Complete travel and activity itinerary planning",
                    isRequired: false,
                    defaultDuration: 120,
                    sortOrder: 4,
                },

                // Tour Guide tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.tour,
                    taskCode: "CITY_WALKING",
                    taskName: "City Walking Tour",
                    description: "Guided walking tour of city highlights",
                    isRequired: false,
                    defaultDuration: 180,
                    sortOrder: 1,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.tour,
                    taskCode: "HISTORICAL_TOUR",
                    taskName: "Historical Sites Tour",
                ...
                },
                {
                    ...
                    categoryId: serviceCategoryIds.tour,
                    taskCode: "FOOD_TOUR",
                    taskName: "Local Food Tour",
                    description: "Experience local cuisine and food culture",
                    isRequired: false,
                    defaultDuration: 180,
                    sortOrder: 3,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.tour,
                    taskCode: "ADVENTURE_TOUR",
                    taskName: "Adventure Activities",
                    description: "Outdoor adventures like hiking, biking, or water sports",
                    isRequired: false,
                    defaultDuration: 300,
                    sortOrder: 4,
                },

                // Spa & Wellness tasks (6 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "FACIAL",
                    taskName: "Facial Treatment",
                ...
                },
                {
                    ...
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "BODY_SCRUB",
                    taskName: "Body Scrub & Wrap",
                    description: "Full body exfoliation and wrap treatment",
                    isRequired: false,
                    defaultDuration: 90,
                    sortOrder: 2,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "MANICURE_PEDICURE",
                    taskName: "Manicure & Pedicure",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "SPA_PACKAGE",
                    taskName: "Full Spa Day Package",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "AROMATHERAPY",
                    taskName: "Aromatherapy Session",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.spa,
                    taskCode: "HAIR_TREATMENT",
                    taskName: "Hair Treatment & Styling",
                    description: "Professional hair care, treatment, and styling",
                    isRequired: false,
                    defaultDuration: 90,
                    sortOrder: 6,
                },

                // Photography tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.photography,
                    taskCode: "PORTRAIT_SESSION",
                    taskName: "Portrait Photography",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.photography,
                    taskCode: "EVENT_COVERAGE",
                    taskName: "Event Photography",
                    description: "Full event coverage with edited photos",
                    isRequired: false,
                    defaultDuration: 240,
                    sortOrder: 2,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.photography,
                    taskCode: "DRONE_PHOTO",
                    taskName: "Drone Photography",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.photography,
                    taskCode: "PRODUCT_PHOTO",
                    taskName: "Product Photography",
                    description: "Professional product photography for business/ecommerce",
                    isRequired: false,
                    defaultDuration: 120,
                    sortOrder: 4,
                },

                // Personal Chef tasks (already covered in dining)
                
                // Massage tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.massage,
                    taskCode: "SWEDISH_MASSAGE",
                    taskName: "Swedish Massage",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.massage,
                    taskCode: "DEEP_TISSUE",
                    taskName: "Deep Tissue Massage",
                ...
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.massage,
                    taskCode: "COUPLES_MASSAGE",
                    taskName: "Couples Massage",
                ...
                // Laundry tasks (4 tasks)
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.laundry,
                    taskCode: "WASH_FOLD",
                    taskName: "Wash & Fold Service",
                ...
                },
                {
                    ...
                    categoryId: serviceCategoryIds.laundry,
                    taskCode: "IRONING",
                    taskName: "Professional Ironing",
                    description: "Expert ironing and pressing service",
                    isRequired: false,
                    defaultDuration: 60,
                    sortOrder: 3,
                },
                {
                    id: randomUUID(),
                    categoryId: serviceCategoryIds.laundry,
                    taskCode: "STAIN_REMOVAL",
                    taskName: "Stain Removal Service",
                    description: "Professional stain treatment and removal",
                    isRequired: false,
                    defaultDuration: 30,
                    sortOrder: 4,
                },
            ...
            console.log(`✓ Created ${sampleServiceTasks.length} service tasks across all categories`);
